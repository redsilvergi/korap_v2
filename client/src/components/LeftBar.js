...
const LeftBar = ({ setData1, setLength, setLD, setIsFilter }) => {
  ...
  const handleCondition = async () => {
    ...
    const response = await axios.get(
      `http://46.51.229.56:4000/conditions/${info.roadNo.selected}/${info.laneOps.checkboxes}/${info.facilOps.checkboxes}/${info.speedOps.checkboxes}/${info.barrierOps.checkboxes}/${info.lightOps.checkboxes}/${info.caronlyOps.checkboxes}/${info.onewayOps.checkboxes}`
    );
